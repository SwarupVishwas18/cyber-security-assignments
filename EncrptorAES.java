...
public class EncrptorAES {
    private static final int[] sBox = { 0x9, 0x4, 0xA, 0xB, 0xD, 0x1, 0x8, 0x5, 0x6,
            0x2, 0x0, 0x3, 0xC, 0xE, 0xF, 0x7 };
    private static final int[] sBoxI = { 0xA, 0x5, 0x9, 0xB, 0x1, 0x7, 0x8, 0xF, 0x6,
            0x0, 0x2, 0x3, 0xC, 0x4, 0xD, 0xE };
    ...
    public static void main(String[] args) {
        ...
        EncrptorAES aes = new EncrptorAES();
        aes.keygen(key);
